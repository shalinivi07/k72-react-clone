    ...
    <div>
      <div className='section1 h-screen'>
        <div ref={imageDivRef} className="  absolute h-[20vw] overflow-hidden w-[15vw] top-10 rounded-3xl left-[30vw]">
          <img ref={imageRef} className='h-full w-full object-cover' src="https://k72.ca/images/teamMembers/Isa_640X960.jpg?w=640&h=960&s=5849bb72bb04be156ba2ff4048eb65b8" alt="" />
        </div>
